...
/**
  ...
  */
class ControllerPollonSpeed(override val maximumCores: Int, Ts: Long, alpha: Double, val avgNominalRate: Long) extends ControllerPollonAbstract(maximumCores, Ts, alpha) {
